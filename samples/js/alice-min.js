...
alice._utils.insertCSSRule('@-webkit-keyframes alice-fade-out-in { 0% { opacity: 1; } 50% { opacity: 0; } 100% { opacity: 1; } }');
...
/*
        elem.addEventListener('webkitTransitionEnd', function (evt) {
            console.log('fade3: webkitTransitionEnd');
        }, false);
*/
        if (params.random) {
            r = Math.random() * (params.random / 50) - params.random / 100;
...
*/
        ...
        s['-webkit-animation-name']            = 'alice-fade-in';
        s['-webkit-animation-duration']        = duration + 's';
        //s['-webkit-animation-iteration-count'] = iteration;
        //s['-webkit-animation-direction']       = 'alternate';
        s['-webkit-animation-timing-function'] = timing;
 ...
 * Fade effect.
 */
alice.fadeOutIn = function (params) {
    // set default values
    var r = 0;
    var duration = 1;
    var iteration = 1;
...
*/
        ...
        s['-webkit-animation-name']            = 'alice-fade-out-in';
        s['-webkit-animation-duration']        = duration + 's';
        //s['-webkit-animation-iteration-count'] = iteration;
        //s['-webkit-animation-direction']       = 'alternate';
        s['-webkit-animation-timing-function'] = timing;
...
alice.spring = function (params) {
    if (document.getElementById(params.id)) {
        ...
        if (params.random) {
            speed = parseFloat(speed) + parseFloat(speed) * r;
        }
        //console.log('speed=' + speed);

        var elasticity = 0.50;
        if (params.elasticity) {
            elasticity = params.elasticity;
        }
        if (params.random) {
            elasticity = parseFloat(elasticity) + parseFloat(elasticity) * r;
        }
        ...
        s['-webkit-animation-duration']        = (speed * 3) + 's';
        s['-webkit-animation-iteration-count'] = iteration;
...
alice.toss = function (params) {
    ...
    if (document.getElementById(params.id)) {
        ...
        elem.addEventListener('webkitTransitionEnd', function (evt) {
            //console.log('toss: webkitTransitionEnd');
        }, false);
...
alice._utils.insertCSSRule('@-webkit-keyframes alice-slide-left { 0% { -webkit-transform: translateX(649px); } 33% { -webkit-transform: translateX(-432px); } 50% {-webkit-transform: translateX(288px); } 67% { -webkit-transform: translateX(-192px); } 75% { -webkit-transform: translateX(128px); } 83% {  -webkit-transform: translateX(-85px); } 88% { -webkit-transform: translateX(57px); } 92% { -webkit-transform: translateX(-38px); } 94% { -webkit-transform: translateX(25px); } 96% { -webkit-transform: translateX(-17px); } 97% { -webkit-transform: translateX(11px); } 98% { -webkit-transform: translateX(-8px); } 99% { -webkit-transform: translateX(5px); } 100% { -webkit-transform: translateX(0px); } }');
alice._utils.insertCSSRule('@-webkit-keyframes alice-slide-up { 0% { -webkit-transform: translateY(649px); } 33% { -webkit-transform: translateY(-432px); } 50% {-webkit-transform: translateY(288px); } 67% { -webkit-transform: translateY(-192px); } 75% { -webkit-transform: translateY(128px); } 83% {  -webkit-transform: translateY(-85px); } 88% { -webkit-transform: translateY(57px); } 92% { -webkit-transform: translateY(-38px); } 94% { -webkit-transform: translateY(25px); } 96% { -webkit-transform: translateY(-17px); } 97% { -webkit-transform: translateY(11px); } 98% { -webkit-transform: translateY(-8px); } 99% { -webkit-transform: translateY(5px); } 100% { -webkit-transform: translateY(0px); } }');
...
/*
        elem.addEventListener('webkitTransitionEnd', function (evt) {
            console.log('slide: webkitTransitionEnd');
        }, false);
*/
        if (params.random) {
            r = Math.random() * (params.random / 50) - params.random / 100;
        ...
        s['-webkit-animation-name']            = 'alice-slide-left';
        s['-webkit-animation-duration']        = duration + 'ms';
        s['-webkit-animation-iteration-count'] = iteration;
        s['-webkit-animation-direction']       = 'alternate';
        s['-webkit-animation-timing-function'] = timing;
