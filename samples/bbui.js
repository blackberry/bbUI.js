...
_bb10_textInput = { 
	...
	style: function(outerElement) {
		...
		outerElement.dokeyup = function() {
								if ((this.value.length == 0 || this.value.length == 1) && this.clearBtn) {							
									outerElement.doFocus();
								}
							};
		outerElement.dokeyup = outerElement.dokeyup.bind(outerElement);	
		outerElement.addEventListener("keyup", outerElement.dokeyup, false);
